...
internal.backup = function backup(vault) {
  ...
  return mkdirp.mkdirpAsync(vault.config.get('backup_dir'), ownmode)
    .then(_.partial(fs.writeFileAsync, backupFile, data, ownmode))
    .then(function () {
